...
class CrudControllerSplitBackpackCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $name = 'backpack:split:crud-controller';
     ...
     * @var string
     */
    protected $signature = 'backpack:split:crud-controller {name}';
     ...
     * @var string
     */
    protected $description = 'Generate a Backpack CRUD with Split controller';
