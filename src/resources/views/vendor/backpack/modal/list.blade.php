    ...
    <div class="{{ $crud->getListContentClass() }}">
      <div class="">
        ...
        <div class="row m-b-10">
            ...
            @if ($crud->buttons->where('stack', 'top')->count())
              @foreach ($crud->buttons->where('stack', 'top') as $button)
                @if ($button->name == 'create')
                 @include('crud::modal.buttons.create', ['button' => $button])
                @else
          ...
          <div class="col-xs-6">
              <div id="datatable_search_stack" class="pull-right" id="search"></div>
          </div>
        </div>
        ...
        <div class="overflow-hidden" id="list">
...
@section('after_scripts')
    ...
    @include('crud::modal.inc.list_js')
